import{i as p,a as e,j as b,h as y,t as h,k as f,s as $,l as z,u as D,S as a,T as u,P as c,I as k,d as P}from"./index-6b593c43.js";import{T as x}from"./Title-4bfa7384.js";import{C as o}from"./index-92015a99.js";import{D as l,a as s,C as I}from"./code-5b64fce7.js";import{p as W}from"./columns-cd2d5c33.js";import{h as T}from"./hljs-409c3200.js";const L=h("<sup>"),j=h('<sup class="cm-badge-dot">'),_=h("<span>"),O=h('<span class="cm-badge-status-text">');function M(r){if(r&&(r.startsWith("#")||r.startsWith("rgb")||r.startsWith("hsl"))){var B=new Option().style;return B.color=r,B.color.startsWith("rgb")}return!1}function t(r){const B=r.overflowCount??99,E=()=>z(r,"cm-badge",{"cm-badge-status":r.status}),C=()=>r.count&&r.count>B?Math.min(B,r.count)+"+":r.count,v=()=>({"cm-badge-status-dot":!0,[`cm-badge-status-${r.status}`]:!!r.status,[`cm-badge-status-${r.color}`]:!!r.color&&r.color.indexOf("#")===-1}),F=()=>({"background-color":M(r.color)?r.color:""}),w=()=>({"cm-badge-count":!0,[`cm-badge-count-${r.type}`]:!!r.type});return(()=>{const m=_();return p(m,()=>r.children,null),p(m,e(y,{get when(){return!r.status&&!r.color},get fallback(){return[(()=>{const n=_();return b(i=>{const A=v(),S=F();return i._v$=f(n,A,i._v$),i._v$2=$(n,S,i._v$2),i},{_v$:void 0,_v$2:void 0}),n})(),(()=>{const n=O();return p(n,()=>r.text),n})()]},get children(){return[e(y,{get when(){return r.count!==void 0||r.text!==void 0},get children(){const n=L();return p(n,C,null),p(n,()=>r.text,null),b(i=>f(n,w(),i)),n}}),e(y,{get when(){return r.dot!==void 0},get children(){return j()}})]}}),null),b(n=>f(m,E(),n)),m})()}const R=`<Space dir="h">
    <Badge count={3}>
