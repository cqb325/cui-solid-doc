import{c as ee,d as te,i as c,a as e,A as J,g as $,F as ne,C as ae,h as re,t as h,j as ie,s as ue,k as se,E as k,u as ge,S as o,T as u}from"./index-5e0fdc25.js";import{S as le}from"./index-8ba692c8.js";import{I as j}from"./input-62bed655.js";import{P as L,a as O,b as N}from"./PageItem-9e5be538.js";import{O as ce}from"./Option-70feb815.js";import{T as B}from"./Title-abffd9c9.js";import{C as f}from"./index-7b04ac17.js";import{D as C,a as P,T as M,p as oe,e as de,C as pe}from"./code-f8e23b11.js";import{P as E}from"./Paragraph-3448cd8e.js";import{h as he}from"./hljs-74a5c6d1.js";import"./EmptyOption-a0a97b87.js";import"./Value-53f54136.js";import"./index-5a242dd5.js";import"./index-93f1e655.js";import"./createField-47c85f73.js";import"./_commonjsHelpers-725317a4.js";const R=h('<li class="cm-pagination-num cm-pagination-ellipse"><span class="ellipse">•••'),me=h('<ul class="cm-pagination-num-list"><span class="cm-pagination-mini-pages">/ '),ze=h('<span class="cm-pagination-text mr-5">共<!>条'),Se=h('<ul class="cm-pagination-num-list">'),fe=h('<span class="cm-pagination-sizer">'),Ce=h('<span class="cm-pagination-jumper"><span class="cm-pagination-text">跳至</span><span class="cm-pagination-text">页'),Pe=h("<div>"),V=[{value:10,label:"10条/页"},{value:20,label:"20条/页"},{value:50,label:"50条/页"},{value:100,label:"100条/页"}];function F(n){const d=()=>se(n,"cm-pagination",{[`cm-pagination-${n.shape}`]:n.shape,[`cm-pagination-${n.size}`]:n.size}),r=()=>n.current,p=()=>n.total??0,m=()=>n.pageSize??10,a=n.innerNear??2,z=n.startEndShowNum??2,q=n.showNums??!0,G=n.showTotal??!0,H=n.pages??V,K=n.showJumper??!0,Q=n.showPage??!0,[x,b]=ee(r());te(()=>{r()!=x()&&b(r())});const T=()=>{r()>1&&y(r()-1)},D=()=>{r()<S()&&y(r()+1)},I=i=>{y(parseInt(i,10))},S=()=>p()===0?1:Math.floor((p()-1)/m())+1,U=i=>typeof i=="number"&&i>=1,y=i=>{let t=i;U(t)&&t!==r()&&(t>S()&&(t=S()),b(t),n.onChange&&n.onChange(t,m))},W=i=>{const t=Math.floor((p()-1)/i)+1;n.onChangePageSize&&n.onChangePageSize(i),r()>t&&(b(1),n.onChange&&n.onChange(1,m))};function X(){const i=S(),t=r()>z+a+1?r()-a:z+1,s=r()+a+z>=i?i-z:r()+a;return{start:t,end:s}}function Y(){if(!q)return null;const i=S(),t=[],s=X(),l=r();for(let g=1;g<=z;g++){let A=l===g;t.push(e(N,{active:A,get onClick(){return y.bind(null,g)},currentIndex:g}))}l>z+a+1&&t.push(R());let v=s.start;const Z=s.end;for(;v<=Z;v++){let g=l===v;t.push(e(N,{get onClick(){return y.bind(null,v)},currentIndex:v,active:g}))}l+a+z<i&&t.push(R());for(let g=i-z+1;g<=i;g++){let A=l===g;t.push(e(N,{active:A,get onClick(){return y.bind(null,g)},currentIndex:g}))}return t}return(()=>{const i=Pe();return c(i,e(ae,{get children(){return[e(J,{get when(){return n.mini},get children(){const t=me(),s=t.firstChild;return s.firstChild,c(t,e(L,{current:r,onClick:T}),s),c(t,e(j,{get style(){return{width:n.size==="small"?"35px":"50px"}},class:"mr-5",value:[x,b],get size(){return n.size},onChange:I}),s),c(s,S,null),c(t,e(O,{current:r,onClick:D,get disabled(){return r()===S()}}),null),t}}),e(J,{get when(){return!n.mini},get children(){return[e($,{when:G,get children(){const t=ze(),s=t.firstChild,l=s.nextSibling;return l.nextSibling,c(t,p,l),t}}),(()=>{const t=Se();return c(t,e(L,{current:r,onClick:T}),null),c(t,Y,null),c(t,e(O,{current:r,onClick:D,get disabled(){return r()===S()}}),null),t})(),e($,{when:Q,get children(){const t=fe();return c(t,e(le,{get value(){return m()},get size(){return n.size},onChange:W,data:H,get children(){return e(ne,{each:V,children:s=>e(ce,{get label(){return s.label},get value(){return s.value}})})}})),t}}),e($,{when:K,get children(){const t=Ce(),s=t.firstChild,l=s.nextSibling;return c(t,e(j,{get style(){return{width:n.size==="small"?"35px":"50px"}},class:"mr-5",value:[x,b],get size(){return n.size},onChange:I}),l),t}})]}})]}})),re(t=>{const s=d(),l=n.style;return t._v$=ie(i,s,t._v$),t._v$2=ue(i,l,t._v$2),t},{_v$:void 0,_v$2:void 0}),i})()}const Ee=`const [page1, setPage1] = createStore({
    current: 1,
    pageSize: 10
})
