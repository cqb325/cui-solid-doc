import{K as k,L as w,d as z,i as M,a as e,M as n,h as N,t as x,u as S,j as L,D as j,k as O,c as P,S as a,N as I,O as m,I as t,T as r,B as $}from"./index-012dff6d.js";import{T as p}from"./Title-7bbcb9dc.js";import{C as A}from"./index-e07e4e01.js";import{D as F,a as E,C as R}from"./code-9a657405.js";import{P as b}from"./Paragraph-690c10ae.js";import{T as D,p as C,e as K}from"./columns-66bf7541.js";import{h as q}from"./hljs-74a5c6d1.js";import"./_commonjsHelpers-725317a4.js";const H=x('<li><ul class="cm-menu-group-list">');function d(l){l.name||console.warn("MenuGroup need name prop");const v=()=>O(l,"cm-menu-group"),c=k();let o,h;return w(()=>{const u=o.parentElement.getAttribute("x-padding");o.setAttribute("x-padding",u),h.setAttribute("x-padding",u);const i=o.parentElement.getAttribute("x-name"),s={name:l.name,parent:null,children:[]};if(c&&l.name)if(c.treeMap[l.name]=s,i==="__root")c?.tree.push(s);else{const g=c.treeMap[i];s.parent=g,g.children.push(s)}}),z(()=>{let u=!1;if(c&&o){const i=o.parentElement.getAttribute("x-name");u=c.store.min&&i==="__root"}!u&&c?.dir==="v"&&setTimeout(()=>{const i=o.parentElement.getAttribute("x-padding"),s=parseInt(i)+16;o.setAttribute("x-padding",i),h.setAttribute("x-padding",s)})}),(()=>{const u=H(),i=u.firstChild,s=o;typeof s=="function"?S(s,u):o=u,M(u,e(n,{get icon(){return l.icon},isSubmenuTitle:!0,get children(){return l.title}}),i);const g=h;return typeof g=="function"?S(g,i):h=i,M(i,()=>l.children),N(B=>{const T=v(),G=l.name;return B._v$=L(u,T,B._v$),G!==B._v$2&&j(i,"x-name",B._v$2=G),B},{_v$:void 0,_v$2:void 0}),u})()}const J=`<Menu dir='h'>
